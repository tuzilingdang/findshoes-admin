      ...
      <div class="tab-head"> 
        ...
        <br />
         <div class="tab-panel active" id="tab-set">
			<div class="tab-panel active" id="tab-set">
				<h1 style="font-size:2em;font-family:Microsoft YaHei; color:#FF6600;margin-left:15em;">添加成功</h1>
			</div>
				<a style="top:-2em;font-family:Microsoft YaHei; margin-left:32.5em;" href="shoes-batchadd.jsp">返回</a>
			</div>
           </div>
